   ...
   public function getDesignSpecializationField(): array {
      ...
      $inputs = [
         _n('Dropdown', 'Dropdowns', 1) => [
            ...
            'hooks' => [ 'change' => 'plugin_formcreator_changeDropdownItemtype("' . $rand . '");' ]  
         ],
         __('Default values') => [
         ...
         __('Show ticket categories', 'formcreator') => [
            'type' => 'select',
            'name' => 'show_ticket_categories',
            'values' => $ticketCategoriesOptions,
            'value' => $decodedValues['show_ticket_categories'] ?? 'both',
            'display' => false,
            'hooks' => [ 'change' => 'plugin_formcreator_changeDropdownItemtype("' . $rand . '");' ]
         ],
         [
         ...
         __('Type', 'formcreator') => [
            'type' => 'select',
            'name' => 'show_service_level_types',
            'values' => [
               SLM::TTO => __('Time to own', 'formcreator'),
               SLM::TTR => __('Time to resolve', 'formcreator'),
            ],
            'value' => $decodedValues['show_service_level_types'] ?? SLM::TTO,
            'display' => false,
         ],
