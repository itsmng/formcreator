...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_forms_validators` (
    ...
    `uuid`                        varchar(255) DEFAULT NULL,
    PRIMARY KEY (`id`),
    UNIQUE KEY `validator_unicity` (`plugin_formcreator_forms_id`,`itemtype`,`items_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_entities` (
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_profiles` (
    `id` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_profiles (id)',
    `right` char(1) collate utf8_unicode_ci default NULL,
    `plugin_formcreator_forms_id` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_groups` (
    `id` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_profiles (id)',
    `right` char(1) collate utf8_unicode_ci default NULL,
    `plugin_formcreator_forms_id` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_users` (
    `id` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_profiles (id)',
    `right` char(1) collate utf8_unicode_ci default NULL,
    `plugin_formcreator_forms_id` int(11) NOT NULL DEFAULT '0',
