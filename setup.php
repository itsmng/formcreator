...
define('PLUGIN_FORMCREATOR_VERSION', '3.2.0');
// Schema version of this version (major.minor only)
define('PLUGIN_FORMCREATOR_SCHEMA_VERSION', '2.19');
...
function plugin_formcreator_check_prerequisites()
{
    ...
    if (
        version_compare(GLPI_VERSION, PLUGIN_FORMCREATOR_ITSMNG_MIN_VERSION, 'lt')
